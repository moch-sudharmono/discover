@if (Sentry::check())
    <div id="sidebar" class="nav-collapse collapse">
        ...
        <ul>
		 ...
		 @if (can_access_menu($current_user, array('stats')))	
       <li class="{!! Request::is('backend/stats*') || Request::is('backend/stats*') ? 'active' : null !!} ">
	 ...
	 @endif
		 ...
		 @if (can_access_menu($current_user, array('eventList')))
			 <li class="has-sub {!! Request::is('backend/eventList*') || Request::is('backend/eventList*') ? 'active' : null !!} ">
                <a href="javascript:;">
                    <i class="icon-book"></i>
                ...
                <ul class="sub">                   
                        <li class="{!! Request::is('backend/eventList') ? 'active' : null !!}">
                           <a href="{!! URL::to('backend/eventList') !!}">
                               Event List
                           </a>
                        </li>
                </ul>
       ...
       <?php /*     @if (can_access_menu($current_user, array('posts')))
			...
			@if (can_access_menu($current_user, array('emailList')))
			 <li class="has-sub {!! Request::is('backend/emailList*') || Request::is('backend/emailList*') ? 'active' : null !!} ">
                <a href="javascript:;">
                    <i class="icon-book"></i>
                ...
                <ul class="sub">                   
                        <li class="{!! Request::is('backend/emailList') ? 'active' : null !!}">
                           <a href="{!! URL::to('backend/emailList') !!}">
                              Email List
                           </a>
                        </li>
                </ul>
