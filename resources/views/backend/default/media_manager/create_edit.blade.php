        ...
        function folder_contents($dir) {
            ...
            .done(function(data) {
                ...
                for (var i = 0; i < data.files.length; i++) {
					...
					var tempv_sdir = data.files[i];					
					var crpath = tempv_sdir.split('public');
					
                 if(crpath[1]){
				  file = '<div class="preview processing image-preview"> <div class="details"> <div class="size file-name">'+file_name+'</div> <div class="options">'+delete_file+'</div><img src="'+window.base_url+'/'+crpath[1]+'" width="64px" alt="" /> </div> </div>';                  	 
				 } else {
