  ...
  <div class="form-bg container"> 
    ...
    <div class="tabbable tabs-right">
      ...
      <ul class="nav nav-tabs right-side  text-center">
        <li class=" col-md-4 col-sm-4 col-xs-4 business" data-uk-scrollspy="{cls:'uk-animation-slide-right', repeat:true, delay:100}"> <a href="#2" data-toggle="tab">
        ...
        <li class="col-md-4 col-sm-4 col-xs-4 municipality" data-uk-scrollspy="{cls:'uk-animation-slide-right', repeat:true, delay:400}"> <a href="#5" data-toggle="tab">
          <div class="col-md-12"> <span class="business-icon"> </span> </div>
          <div class="col-md-12 text-center">
            <h3>Municipality</h3>
            <small>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when </small> </div>
          </a> </li>
        <li class="col-md-4 col-sm-4 col-xs-4 club" data-uk-scrollspy="{cls:'uk-animation-slide-right', repeat:true, delay:800}"> <a href="#6" data-toggle="tab">
