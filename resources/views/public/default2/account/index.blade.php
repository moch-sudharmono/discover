...
<div class="tabbable tabs-left">
  ...
  <div class="tab-content form-group col-lg-8 col-sm-8 col-xs-12 ">
    ...
    @endif
      ...
      <label class="col-lg-3 col-sm-3 col-xs-12 row"> <span class="require-val">*</span>Full Name :</label>
      <div class="col-lg-6 col-sm-9 col-xs-12 send"> 
		...
		<div class="form-group col-lg-12 col-sm-12 col-xs-12">
      <label class="col-lg-3 col-sm-3 col-xs-12 row"> <span class="require-val">*</span>Email : </label>
      <div class="col-lg-6 col-sm-9 col-xs-12 send"> 
      ...
      <div class="col-lg-6 col-sm-9 col-xs-12 send"> 
		...
		<div class="form-group col-lg-12 col-sm-12 col-xs-12">
      <label class="col-lg-3 col-sm-3 col-xs-12 row"><span class="require-val">*</span>Country :</label>
      <div class="col-lg-6 col-sm-9 col-xs-12 send"> 			 
		...
		<div class="form-group col-lg-12 col-sm-12 col-xs-12">
      <label class="col-lg-3 col-sm-3 col-xs-12 row"><span class="require-val">*</span>Province/State :</label>
      <div class="col-lg-6 col-sm-9 col-xs-12 send"> 						
				<?php 
          $getsdata = DB::table('states')
                        ->where('country_id', '=', $user_data[0]->country)
                        ->select('id','name')
                        ->get(); 
        ?>  
		...
		<div class="form-group col-lg-12 col-sm-12 col-xs-12">
      <label class="col-lg-3 col-sm-3 col-xs-12 row"><span class="require-val">*</span>City :</label>
      <div class="col-lg-6 col-sm-9 col-xs-12 send">                   
      ...
      <div class="col-lg-6 col-sm-9 col-xs-12 send"> 
		...
		<div class="form-group col-lg-12 col-sm-12 col-xs-12">
      <label class="col-lg-3 col-sm-3 col-xs-12 row"><span class="require-val">*</span>Phone :</label>
      <div class="col-lg-6 col-sm-9 col-xs-12 send"> 
