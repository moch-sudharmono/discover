    ...
    <div class="tabbable tabs-left">
        ...
        <div class="tab-content form-group col-lg-8 col-sm-8 col-xs-12">
            ...
            <form class="form-inline" method="post" action="" enctype="multipart/form-data">				
                        ...
                        <div class="col-lg-6 col-sm-6 col-xs-12 row margin-b10">
                            <div class="row">
                                ...
                                <div class="input-group date custom-dtime" id="datetimepicker2"> 
                                    <input type="text" name="sevent_date" id="sevent_date" class="form-control" value="{{ old('sevent_date') }}"/>
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12 rem-text">Social Media<br><input type="checkbox" name="social_link" id="social_link" value="y">
                ...
                <div class="col-lg-11 col-sm-11 col-xs-11 rem-text" id="private_option" style=" @if(!empty(old('private_event')) && old('private_event') == 'y') display:block; @else  display:none; @endif float: right;">
                    <input type="checkbox" class="sip_event" name="sharepinvt_event" value="y" 
                           @if(old('sharepinvt_event') != '') 
                                checked
                            @endif
                           />
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12 rem-text">
                    <input type="checkbox" id="option" name="available_purchase" value="y"
                           @if(old('available_purchase') != '') 
                                checked
                            @endif
                           >
...
<Script>
    $(document).ready(function () {
        ...
        $('#event_category').load('{!!URL("account/event-data/$account_type/indoor/ndye")!!}');
        ...
        $('body').delegate(".event_type", 'click', function () {
            ...
            if (gradioValue) {
                $('#event_category').load('{!!URL("account/event-data/$account_type/' + gradioValue + '/ndye")!!}');
            }
        });
