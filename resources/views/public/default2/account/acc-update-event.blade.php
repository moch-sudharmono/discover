...
<?php $evtoimg = DB::table('event_catimages')->where('id', '=', $edit_event[0]->event_image)->select('id','ecat_name','ecat_path','ecat_image')->get(); ?>
	...
	<input type="hidden" value="" name="our_pid" id="our_pid"/>
			...
			<div class="form-group col-lg-12 col-sm-12 col-xs-12">
              <label class="col-lg-3 col-sm-3 col-xs-12 row"> <span class="require-val">*</span>
				Venue / Location:
              </label>
...
<div class="form-group col-lg-12 col-sm-12 col-xs-12">
              ...
              <div class="col-lg-6 col-sm-9 col-xs-12 send"> 
				...
				<input type="radio" name="event_cost" class="event_cost" value="free" @if(!empty($event_cost) && $event_cost == 'free') checked @else checked @endif/> 
...
<select class="time-set" name="eevent_time">
 ...
 <!-----multi-date----->	
  <div class="new-period">
   @if($edit_event[0]->event_dtype == 'multi')	 
 <?php $wanotfdata = DB::table('event_multidate')->where('ev_id', '=', $edit_event[0]->eid)->get(); $p = 1; ?>
