	  ...
	  @include("public/default2/_layouts._AccountMenu")
		...
		<div class="form-group col-lg-12 col-sm-12 col-xs-12">
		 ...
		 <div class="col-lg-6 col-sm-6 col-xs-12">
			...
			<div class="form-group col-lg-12 col-sm-12 col-xs-12">
              <label class="col-lg-3 col-sm-3 col-xs-12 row"> Venue/Location :
              </label>
              <div class="col-lg-6 col-sm-6 col-xs-12 send"> 
		 ...
		 @endif  			 
			...
			<div class="col-lg-12 col-sm-12 col-xs-12 rem-text">
                      <input type="checkbox" id="option" name="available_purchase" value="option">
                      ...
                      Private Event <h6>(If check, Event will not be advertised to public. Only people you send the Event link to will have access to the event details).</h6></div>
