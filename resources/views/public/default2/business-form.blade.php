                    ...
                    <div class="personal-form">
                        <form class="form-inline" method="post" action="{{url('bmc-form')}}" enctype="multipart/form-data">             
                            <div class=" per-1 active">
                                ...
                                <!----
                                @if ($errors->has() || !empty(Session::get('failed_upfile')))
                               ...
                               ---->
                                ...
                                <div class="frm-one">
                                    <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                                        <input type="text" placeholder="Business Name " value="{{ old('name') }}" name="name" class="form-control" required />	
                                        {!! $errors->first('name', '<span class="help-block with-errors">The Business name has already been taken. please use different name</span>') !!}						  
                                    </div>
                                    <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                                ...
                                <div class="frm-one">
                                    ...
                                    <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                                        <input type="text" name="website" value="{{ old('website') }}" placeholder="Website" class="form-control"  id="website" required />
                                    </div>
                                ...
                                <input type="hidden" name="actype" value="business">
                                <div class="form-group col-lg-6 col-sm-6 col-xs-12">
