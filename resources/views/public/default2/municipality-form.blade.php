                        ...
                        <form class="form-inline" method="post" action="{{url('bmc-form')}}" enctype="multipart/form-data">
                            <div class=" per-1 active">
                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                    <h4> Municipality Detail </h4>
                                    <p>Municipality Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry.</p>
                                </div>
                                ...
                                <div class="frm-one">	
                                    <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                                        ...
                                        {!! $errors->first('name', '<span class="help-block with-errors">The Name has already been taken. please use different name</span>') !!}						  
                                    </div>
                                    <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                                        <input type="text" placeholder="Phone Number" name="phone" id="phone" value="{{ old('phone') }}" class="form-control" required />
                                        {!! $errors->first('phone', '<span class="help-block with-errors">:message</span>') !!}	
                                    </div>
                                </div>
                                <div class="frm-one">
                                    <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                                        <input type="text" placeholder="Address " name="address" value="{{ old('address') }}" class="form-control" required />
                                ...
                                <input type="hidden" name="actype" value="municipality">
                                <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                                    <input type="text" name="zip_code" placeholder="Postal/Zip Code" value="{{ old('zip_code') }}" class="form-control" required />
