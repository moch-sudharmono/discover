                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0">
                                                        ...
                                                        <tr>
                                                            <td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                                <h1 style="color: #202020; display: block; font-family: Helvetica; font-size: 24px; font-style: normal; font-weight: bold; line-height: 200%; letter-spacing: normal; margin: 0; margin-bottom: 0; text-align: left">Hi, <br>
																accept admin reasonability for {{$caccount_name}} account. {{$uname}} admin user sent the request for you.<br>
																</h1>
                                                                <h2 style="color: #606060; display: block; font-family: Helvetica; font-size: 18px; font-style: italic; font-weight: normal; line-height: 110%; letter-spacing: normal; margin: 0; margin-bottom: 20px; text-align: left"></h2>
                                                                <h3 style="color: #666; display: block; font-family: Helvetica; font-size: 16px; font-style: normal; font-weight: normal; line-height: 110%; letter-spacing: normal; margin: 0; margin-bottom: 9px; text-align: left">
																Click <a href="{{$redirect_url}}">here</a> to accept the request and check the account information</h3>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0">
                                                        ...
                                                        <tr>
                                                            <td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; font-size:11px;color:#a9a9a9;padding-bottom:9px;text-align:center;padding-right:18px;padding-left:18px;padding-top:9px;">
                                                                <p style="margin: 0; padding-bottom: 1em">Event Site Inc. Â© 2015</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
