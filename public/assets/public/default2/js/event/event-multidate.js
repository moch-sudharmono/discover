...
$(function(){ 
  ...
  $("#add-event-btn").click(function(event)
 {
  ...
  if(ev_occur && ev_occur == 'Monthly'){ 
   ...
   $('<p class="newitc-periods" id="new-period'+i+'"><span class="multi-ctdata"><label><span class="cvs-count" id="cvs-count'+i+'">'+dctc+'</span><br>Dates</label></span><span class="multi-listdata"><span class="evdetails">'+evdetails+'</span><br><span class="sd">'+show_date+'</span></span><span class="multi-removediv"> <a href="javascript:void(0)" class="event-edit" onClick="editmud('+i+');">Edit</a> <a href="javascript:void(0)" class="event-remove" onClick="removemud('+i+');" id="remScnt">Remove</a></span><input type="hidden" value="'+$("#sd").val()+'" id="arrdate'+i+'" name="arrdate[]"/><input type="hidden" value="'+$("#ed").val()+'" id="enddate'+i+'" name="enddate[]"/><input type="hidden" value="'+nspvl_itcperiod+'" id="ofthe'+i+'" name="ofthe[]"/><input type="hidden" value="'+stvl_ftime+'" id="startime'+i+'" name="startime[]"/><input type="hidden" value="'+edvl_totime+'" id="endtime'+i+'" name="endtime[]"/><input type="hidden" value="'+ev_occur+'" id="nspd'+i+'" name="nspd[]"/><input type="hidden" value="'+st_ftime+'" id="st_format'+i+'" name="st_format[]"/><input type="hidden" value="'+ed_totime+'" id="et_format'+i+'" name="et_format[]"/><input type="hidden" value="'+dctc+'" id="total_day'+i+'" name="total_day[]"/><input type="hidden" value="'+nsp_itcmontyday+'" id="mw_date'+i+'" name="mw_date[]"/><input type="hidden" value="'+wgtdaysvl+'" id="wgtdaysvl'+i+'" name="wgtdaysvl[]"/></p>').appendTo(scntDiv);
	$(".start-end_multiple").hide();
	$(".new-period").show();
	$("#add_edate").show();
	$("#cancel_repevent").show();	
...
//alert(spanid);	
  ...
  $(document).on( "click", "#update-event-btn", function(event)
 {
   ...
   if(ev_occur && ev_occur == 'Monthly') { 
	...
	var evdetails = ev_occur+' '+st_ftime+' - '+ed_totime+sd_text; 
   } //arrdate evdetails 	arrdate
  $('#new-period'+gt_ulid).html('<span class="multi-ctdata"><label><span class="cvs-count" id="cvs-count'+gt_ulid+'">'+dctc+'</span><br>Dates</label></span><span class="multi-listdata"><span class="evdetails">'+evdetails+'</span><br><span class="sd">'+show_date+'</span></span><span class="multi-removediv"> <a href="javascript:void(0)" class="event-edit" onClick="editmud('+gt_ulid+');">Edit</a> <a href="javascript:void(0)" onClick="removemud('+gt_ulid+');" class="event-remove" id="remScnt">Remove</a></span><input type="hidden" value="'+$("#edit_sd").val()+'" id="arrdate'+gt_ulid+'" name="arrdate[]"/><input type="hidden" value="'+$("#edit_ed").val()+'" id="enddate'+gt_ulid+'" name="enddate[]"/><input type="hidden" value="'+nspvl_itcperiod+'" id="ofthe'+gt_ulid+'" name="ofthe[]"/><input type="hidden" value="'+stvl_ftime+'" id="startime'+gt_ulid+'" name="startime[]"/><input type="hidden" value="'+edvl_totime+'" id="endtime'+gt_ulid+'" name="endtime[]"/><input type="hidden" value="'+ev_occur+'" id="nspd'+gt_ulid+'" name="nspd[]"/><input type="hidden" value="'+st_ftime+'" id="st_format'+gt_ulid+'" name="st_format[]"/><input type="hidden" value="'+ed_totime+'" id="et_format'+gt_ulid+'" name="et_format[]"/><input type="hidden" value="'+dctc+'" id="total_day'+gt_ulid+'" name="total_day[]"/><input type="hidden" value="'+nsp_itcmontyday+'" id="mw_date'+gt_ulid+'" name="mw_date[]"/><input type="hidden" value="'+wgtdaysvl+'" id="wgtdaysvl'+gt_ulid+'" name="wgtdaysvl[]"/>');
	$(".edit-se_multiple").hide();
	$(".new-period").show();
	$("#add_edate").show();
	$("#cancel_repevent").show();	
